  ...
  : iisTaskPanelScheme(parent)
{
  ...
  headerBackgroundOver = QBrush(0x225aca);
  headerBorderOver = QColor(0x225aca);

  headerSize = 25;
  headerAnimation = false;

  headerCorners = iisRect(4,4,0,0);
  ...
  groupBackgroundOver = QBrush(0xeff3ff);
  groupBorderOver = QColor(0xffffff);
  ...
  : iisTaskPanelScheme(parent)
{
  ...
  headerBorderOver = QPen(Qt::NoPen);
  ...
  groupBorder = QColor(0xffffff);
  groupBackgroundOver = QBrush(0xd6dff7);
  groupBorderOver = QColor(0xffffff);
