...
void test::on_rbVista_clicked()
{
  ui.panel->setScheme(iisVistaTaskPanelScheme::defaultScheme());

//  tb1->setScheme(iisVistaTaskPanelScheme::defaultScheme());
//  tb2->setScheme(iisVistaTaskPanelScheme::defaultScheme());
//  tb3->setScheme(iisVistaTaskPanelScheme::defaultScheme());
//  tb4->setScheme(iisVistaTaskPanelScheme::defaultScheme());
}
